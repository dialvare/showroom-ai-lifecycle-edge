...
Welcome to the *Dashboard Control Center* - your central hub for accessing, monitoring and managing all the relevant dashboards involved in this demo. Some of them will be deployed along the way and cannot be accessed right now, but you can always come back here to quickly find the URLs and credentials needed from a central page
...
[source,bash,subs="attributes+"]
----
https://hods-dashboard-redhat-ods-applications.{openshift_cluster_ingress_domain}
----

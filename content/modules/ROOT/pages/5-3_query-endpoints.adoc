...
----
https://stress-detection-predictor.ai-edge-project.svc.cluster.local
----
...
[source,bash,subs="attributes+"]
----
https://time-to-failure-predictor.ai-edge-project.svc.cluster.local
----

. Run the second cell to test the inference endpoint for the Time to Failure model.

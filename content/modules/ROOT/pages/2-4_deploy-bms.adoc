...
* *Data Processing Components*: Two Quarkus services that process MQTT data:
  - _mqtt2ws service that exposes data as WebSocket for the BMS dashboard
...
* Select the *bms* and *battery_data* filters.
* Click *Submit* to execute the query.

Data will start appearing from the right side of the screen. If you recently deployed the BMS app, the data may be difficult to see, so you can adjust the time interval to expand the graph. The following image shows data generated over the last 15 minutes:

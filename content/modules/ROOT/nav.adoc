...
** xref:2-4_deploy-bms.adoc[2.4 Deploying the BMS app]
...
** xref:6-2_pipeline-execution.adoc[6.2 Pipeline execution]
** xref:6-3_pipeline-automation.adoc[6.3 Pipeline automation]

* 7. Model Monitoring
** xref:7-1_trustyai.adoc[7.1 TrustyAI]
** xref:7-2_TODO-bias.adoc[7.2 Detect bias]
** xref:7-3_TODO-drift.adoc[7.3 Data drift]

* 8. Battery Monitoring System
** xref:8-1_TODO-test-alerts.adoc[8.1 Testing alerts]